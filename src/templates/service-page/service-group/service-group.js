...
export default ({ data, index, showModal }) => {
  return (
    <section
      className={`service-group service-group__wrapper-${
      ...
      <div className="service-group__container">
        ...
        <div className="call-manager-block">
          <div>
            <div className="service-group__price_example_caption">
              Примеры цен
            </div>
            <div className="service-group__description">
              Если в списке нет интересующих вас работ или у вас есть вопросы по
              ценам, задавайте вопрос менеджеру.
            </div>
          </div>
